...
function responsive_map_css() {
    wp_register_style('responsive_map_css', plugins_url('includes/css/style.css', __FILE__), false, '2.17');
...
function admin_responsive_map_scripts() {
    ...
    wp_register_script('rsmaps', plugins_url('includes/js/rsmaps.functions.js', __FILE__), array('jquery'), '2.17');
