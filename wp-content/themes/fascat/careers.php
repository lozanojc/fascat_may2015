...
?>
       ...
       <div id="content" class="page col-full">
        ...
        <ul id="submenu">
              <li><a href="<?php echo($siteUrl = site_url());?>/about/">Company Overview</a></li>
              <li><a href="<?php echo $siteUrl?>/about/partners/">Partners</a></li>
              <li class="active"><a href="<?php echo $siteUrl?>/about/careers/">Careers</a></li>
              <li><a href="<?php echo $siteUrl?>/contact-us/">Contact Information</a></li>
            </ul>
        <div class="clear"></div>
