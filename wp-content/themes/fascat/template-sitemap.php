       ...
       <div class="content_wrapper">    
		...
		<section id="main" class="col-left"> 
			...
			<div class="col-1">	
		            	...
		            	<h3><?php _e( 'Categories', 'fascat' ) ?></h3>
		        	    ...
		        	    <h3><?php _e( 'Posts per category', 'fascat' ); ?></h3>
						...
						<li style="font-weight:normal !important;"><a href="<?php the_permalink() ?>"><?php the_title(); ?></a> - <?php _e( 'Comments', 'fascat' ) ?> (<?php echo $post->comment_count ?>)</li>
			...
			<div class="col-2">	
				...
				<h3><?php _e( 'Product Categories', 'fascat' ) ?></h3>
