...
if ( post_password_required() ) { ?>
	...
	<p class="nocomments"><?php _e( 'This post is password protected. Enter the password to view comments.', 'fascat' ); ?></p>
...
<div id="comments">
	...
	<?php if ( ! empty( $comments_by_type['comment'] ) ) { ?>
		...
		<h2><?php comments_number( __( 'No Responses', 'fascat' ), __( 'One Response', 'fascat' ), __( '% Responses', 'fascat' ) ); ?> <?php _e( 'to', 'fascat' ); ?> &#8220;<?php the_title(); ?>&#8221;</h2>
	...
	<?php if ( ! empty( $comments_by_type['pings'] ) ) { ?>
        ...
        <h3 id="pings"><?php _e( 'Trackbacks/Pingbacks', 'fascat' ); ?></h3>
	...
	<?php 
		...
		if ( comments_open() && is_singular() ) { ?>
			...
			<div id="comments">
				...
				<h5 class="nocomments"><?php _e( 'No comments yet.', 'fascat' ); ?></h5>
