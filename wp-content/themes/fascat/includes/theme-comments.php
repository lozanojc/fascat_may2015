	      	...
	      	<div id="li-comment-<?php comment_ID() ?>" class="comment-container">
	            ...
	            <?php } ?>            
		      	...
		      	<div class="comment-head">
	                ...
	                <span class="date"><?php echo get_comment_date( get_option( 'date_format' ) ); ?> <?php _e( 'at', 'fascat' ); ?> <?php echo get_comment_time( get_option( 'time_format' ) ); ?></span>

	                <span class="perma"><a href="<?php echo get_comment_link(); ?>" title="<?php esc_attr_e( 'Direct link to this comment', 'fascat' ); ?>"><?php _e( 'Permalink', 'fascat' ); ?></a></span>

	                <span class="edit"><?php edit_comment_link(__( 'Edit', 'fascat' ), '', '' ); ?></span>
				...
				<?php if ( $comment->comment_approved == '0' ) { ?>
	                ...
	                <p class='unapproved'><?php _e( 'Your comment is awaiting moderation.', 'fascat' ); ?></p>
