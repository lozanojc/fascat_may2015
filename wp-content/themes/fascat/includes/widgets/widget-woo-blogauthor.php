...
class Woo_BlogAuthorInfo extends WP_Widget {
	...
	function Woo_BlogAuthorInfo() {
		...
		$widget_ops = array( 'description' => 'This is a fascat Blog Author Info widget.' );

		parent::WP_Widget( false, __( 'Woo - Blog Author Info', 'fascat' ), $widget_ops );
	...
	function form( $instance ) {
		...
		<p>
		   ...
		   <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:','fascat'); ?></label>
		...
		<p>
		   ...
		   <label for="<?php echo $this->get_field_id('bio'); ?>"><?php _e('Bio:','fascat'); ?></label>
		...
		<p>
		   ...
		   <label for="<?php echo $this->get_field_id('custom_email'); ?>"><?php _e('<a href="http://www.gravatar.com/">Gravatar</a> E-mail:','fascat'); ?></label>
		...
		<p>
		   ...
		   <label for="<?php echo $this->get_field_id('avatar_size'); ?>"><?php _e('Gravatar Size:','fascat'); ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('avatar_align'); ?>"><?php _e('Gravatar Alignment:','fascat'); ?></label>

			<select name="<?php echo $this->get_field_name('avatar_align'); ?>" class="widefat" id="<?php echo $this->get_field_id('avatar_align'); ?>">

				<option value="left" <?php if($avatar_align == "left"){ echo "selected='selected'";} ?>><?php _e('Left', 'fascat'); ?></option>

				<option value="right" <?php if($avatar_align == "right"){ echo "selected='selected'";} ?>><?php _e('Right', 'fascat'); ?></option>            
		...
		<p>
		   ...
		   <label for="<?php echo $this->get_field_id('read_more_text'); ?>"><?php _e('Read More Text (optional):','fascat'); ?></label>
		...
		<p>
		   ...
		   <label for="<?php echo $this->get_field_id('read_more_url'); ?>"><?php _e('Read More URL (optional):','fascat'); ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('page'); ?>"><?php _e('Visible Pages:','fascat'); ?></label>

			<select name="<?php echo $this->get_field_name('page'); ?>" class="widefat" id="<?php echo $this->get_field_id('page'); ?>">

				<option value="all" <?php selected( $page, 'all' ); ?>><?php _e('All', 'fascat'); ?></option>

				<option value="home" <?php selected( $page, 'home' ); ?>><?php _e('Home only', 'fascat'); ?></option>

				<option value="single" <?php selected( $page, 'single' ); ?>><?php _e('Single only', 'fascat'); ?></option>
