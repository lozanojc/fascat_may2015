...
class Woo_EmbedWidget extends WP_Widget {
	...
	function Woo_EmbedWidget() {
		...
		parent::WP_Widget( false, __( 'Woo - Embed/Video', 'fascat' ), $widget_ops );
	...
	function form( $instance ) {
		...
		?>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('cat_id'); ?>"><?php _e('Category:','fascat'); ?></label>
...
?>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('tag'); ?>">Or <?php _e('Tag:','fascat'); ?></label>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('width'); ?>"><?php _e('Size:','fascat'); ?></label>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('limit'); ?>"><?php _e('Limit (optional):','fascat'); ?></label>
