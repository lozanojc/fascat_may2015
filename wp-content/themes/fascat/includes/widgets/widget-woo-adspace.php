...
class Woo_AdWidget extends WP_Widget {
	...
	function Woo_AdWidget() {
		...
		parent::WP_Widget(false, __('Woo - Adspace Widget', 'fascat'),$widget_ops);      
...
<?php if ( current_user_can( 'unfiltered_html' ) ) : // Only show it to users who can edit it ?>
	...
	<p>
		...
		<label for="<?php echo $this->get_field_id('adcode'); ?>"><?php _e('Ad Code:','fascat'); ?></label>
...
<?php endif; ?>
	...
	<p>
		...
		<label for="<?php echo $this->get_field_id('image'); ?>"><?php _e('Image Url:','fascat'); ?></label>
	...
	<p>
		...
		<label for="<?php echo $this->get_field_id('href'); ?>"><?php _e('Link URL:','fascat'); ?></label>
	...
	<p>
		...
		<label for="<?php echo $this->get_field_id('alt'); ?>"><?php _e('Alt text:','fascat'); ?></label>
