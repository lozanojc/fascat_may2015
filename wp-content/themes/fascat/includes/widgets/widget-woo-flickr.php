...
class Woo_flickr extends WP_Widget {
	...
	function Woo_flickr() {
		...
		parent::WP_Widget( false, __( 'Woo - Flickr', 'fascat' ), $widget_ops );
	...
	function widget( $args, $instance ) {
		...
		<?php _e( 'Photos on <span>flick<span>r</span></span>', 'fascat' ); ?>
...
?>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'id' ); ?>"><?php _e( 'Flickr ID (<a href="http://www.idgettr.com">idGettr</a>):', 'fascat' ); ?></label>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number:', 'fascat' ); ?></label>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'type' ); ?>"><?php _e( 'Type:', 'fascat' ); ?></label>

				<select name="<?php echo $this->get_field_name( 'type' ); ?>" class="widefat" id="<?php echo $this->get_field_id( 'type' ); ?>">

					<option value="user" <?php selected( $type, 'user' ); ?>><?php _e( 'User', 'fascat' ); ?></option>

					<option value="group" <?php selected( $type, 'group' ); ?>><?php _e( 'Group', 'fascat' ); ?></option>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'sorting' ); ?>"><?php _e( 'Sorting:', 'fascat' ); ?></label>

				<select name="<?php echo $this->get_field_name( 'sorting' ); ?>" class="widefat" id="<?php echo $this->get_field_id( 'sorting' ); ?>">

					<option value="latest" <?php selected( $sorting, 'latest' ); ?>><?php _e( 'Latest', 'fascat' ); ?></option>

					<option value="random" <?php selected( $sorting, 'random' ); ?>><?php _e( 'Random', 'fascat' ); ?></option>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'size' ); ?>"><?php _e( 'Size:', 'fascat' ); ?></label>

				<select name="<?php echo $this->get_field_name( 'size' ); ?>" class="widefat" id="<?php echo $this->get_field_id( 'size' ); ?>">

					<option value="s" <?php selected( $size, 's' ); ?>><?php _e( 'Square', 'fascat' ); ?></option>

					<option value="m" <?php selected( $size, 'm' ); ?>><?php _e( 'Medium', 'fascat' ); ?></option>

					<option value="t" <?php selected( $size, 't' ); ?>><?php _e( 'Thumbnail', 'fascat' ); ?></option>
