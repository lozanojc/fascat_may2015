...
if (!function_exists( 'the_widgets_init')) {
	...
	function the_widgets_init() {
	    ...
	    register_sidebar(array( 'name' => 'Secondary','id' => 'secondary','description' => "Sidebar for tip articles", 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
