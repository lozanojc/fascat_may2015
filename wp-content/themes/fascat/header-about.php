...
<div id="wrapper" style="min-width:1311px">
...
<!--Social links starts here-->
     <div class="social-links">
        <ul>
          <li><a target="_blank" href="<?php echo stripslashes( $woo_options['woo_connect_facebook'] ); ?>" class="facebook"></a></li>
          <li><a target="_blank" href="<?php echo stripslashes( $woo_options['woo_connect_twitter'] ); ?>" class="twitter"></a></li>
          <li><a target="_blank" href="<?php echo stripslashes( $woo_options['woo_connect_googleplus'] ); ?>" class="google-plus"></a></li>
        </ul>
      </div>
