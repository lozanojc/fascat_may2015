...
?>
	...
	<article <?php post_class(); ?>>
		...
		<section class="post-content">
			...
			<?php if ( isset( $woo_options['woo_post_content'] ) && $woo_options['woo_post_content'] == 'content' ) { the_content( __( 'Continue Reading &rarr;', 'fascat' ) ); } else { the_excerpt(); } ?>
	    ...
	    /*
   		...
   		A loop field named "home_products" with sub-fields "products_image", "product_url"
	    ...
	    */
	     ...
	     if (!empty($fields)) {
	     	...
	     	foreach ($fields as $field) {
    	     	...
    	     	echo "<div class='feature_box'><p>{$field['product_url']}</p>";

    		echo '<img src="'.$field['products_image'].'" /></div>';
