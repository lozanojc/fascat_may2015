...
Description: fascat shortcode generator.
...
class fascat_Shortcode_Generator {
...
-----------------------------------------------------------------------------------*/
	...
	function fascat_Shortcode_Generator () {
	...
	} // End fascat_Shortcode_Generator()
...
-----------------------------------------------------------------------------------*/
	...
	function filter_mce_buttons( $buttons ) {
		...
		array_push( $buttons, '|', 'fascat_shortcodes_button' );
...
-----------------------------------------------------------------------------------*/
	...
	function filter_mce_external_plugins( $plugins ) {
        ...
        $plugins['fascatShortcodes'] = wp_nonce_url( esc_url( $this->framework_url() . 'js/shortcode-generator/editor_plugin.js' ), 'wooframework-shortcode-generator' );
...
$woo_shortcode_generator = new fascat_Shortcode_Generator();
?>