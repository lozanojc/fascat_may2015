...
- fascat Custom Navigation Setup

-- fascat Custom Navigation Setup

-- fascat Custom Navigation Menu Item

-- fascat Custom Navigation Scripts

- fascat Custom Navigation Interface

- fascat Custom Navigation Functions
...
function woo_custom_navigation_deprecation_notice( $function ) {
	...
	trigger_error( sprintf( __( '%1$s is <strong>deprecated</strong> since version %2$s of the WooFramework! Use %3$s instead.', 'fascat' ), $function, '5.4', __( 'WordPress Menu Management', 'fascat' ) ) );
...
/* fascat Custom Navigation Menu Setup
...
/* fascat Custom Navigation Menu Interface
