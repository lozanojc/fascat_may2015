...
function woo_themeoptions_redirect () {
	...
	header( 'Location: ' . admin_url( 'admin.php?page=fascat&activated=true' ) );
...
if ( ! function_exists( 'fascat_admin_head' ) ) {
...
function fascat_admin_head() {} // End fascat_admin_head()

}

add_action( 'admin_head', 'fascat_admin_head', 10 );





if ( ! function_exists( 'fascat_wp_head' ) ) {
...
function fascat_wp_head() {

	do_action( 'fascat_wp_head_before' );
	...
	do_action( 'fascat_wp_head_after' );

} // End fascat_wp_head()

}

add_action( 'wp_head', 'fascat_wp_head', 10 );
...
function woo_load_textdomain () {
	...
	load_theme_textdomain( 'fascat' );

	load_theme_textdomain( 'fascat', get_template_directory() . '/lang' );

	if ( function_exists( 'load_child_theme_textdomain' ) )

		load_child_theme_textdomain( 'fascat' );
